...
void BN_WT_AND_BIAS_TRANS_FUNCTION_MVM_BN(struct FPGA_HBM_MVM_BN_cfg cfg, int *bn_bias, int *bn_wt, int *HBM_DDR[]);
void DAT_OUT_DEMAP_FUNCTION_MVM_BN(struct FPGA_HBM_MVM_BN_cfg cfg, uint16_t *dat_out_mem, uint16_t *dat_out[]);

#include "HBM_DDR_mvm_bn.cpp"