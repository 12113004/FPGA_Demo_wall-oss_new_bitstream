...
struct FPGA_HBM_TRP_cfg
{
    ...
    int      DAT_IN_ONE_HEAD_STRIDE;
    int      DAT_IN_ALL_HEAD_STRIDE;
    int      DAT_IN_SURFACE_STRIDE;
    int      DAT_IN_LINE_STRIDE;
    int      Original_Head_x_CHin;
    int      Original_Head_x_CHin_div_LTout;
    int      Feature_Head_in_Padding;
    int      Feature_Head;
    int      Head_x_CHin;
