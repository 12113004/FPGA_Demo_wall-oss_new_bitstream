...
struct FPGA_HBM_TRP_cfg GetFPGA_HBM_TRP_cfg(int This_Token, int Last_Token, int WT_CHin, int Original_Feature_Head, int Weight_Head, int MAX_CH_per_HEAD, int MAX_TOKEN, uint64_t DAT_IN_BASE_ADDR, uint64_t WT_BASE_ADDR, uint64_t DAT_OUT_BASE_ADDR)
{
    ...
    ret.WT_CHin                        = (WT_CHin);  //Actually only This_Token-weight is valid, not MAX_TOKEN-weight
