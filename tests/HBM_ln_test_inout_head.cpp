...
void HBM_ln_inout_head_test(struct FPGA_HBM_LN_inout_head_cfg cfg, char* path_name, char* head_name, struct bin_inf* dat_in_bin_inf, struct bin_inf* ln_weight_bin_inf, struct bin_inf* ln_bias_bin_inf, struct bin_inf* dat_in_HBM_inf[], int en_0, struct bin_inf* ln_wt_and_bias_HBM_inf[], int en_1)
{
    ...
    read_bin_with_head(dat_in_bin_inf->bin_data_file, dat_in, cfg.Padding_Feature_Head, cfg.Hin*cfg.Win*cfg.CHin);
    ...
    read_bin_with_head(ln_weight_bin_inf->bin_data_file, LN_weight, cfg.Padding_Feature_Head, cfg.CHout);
    ...
    read_bin_with_head(ln_bias_bin_inf->bin_data_file, LN_bias, cfg.Padding_Feature_Head, cfg.CHout);
    ...
    //             {
    //                 if(m<5) dat_in[i][j*cfg.Win*cfg.CHin+k*cfg.CHin+m] = 0x3c00;
    //                 else dat_in[i][j*cfg.Win*cfg.CHin+k*cfg.CHin+m] = 0x0000;
    //             }
    //         }
    //     }
    // }
    // for(int i=0;i<cfg.Padding_Feature_Head;i++)
    // {
    //     for(int j=0;j<cfg.CHout;j++)
    //         LN_weight[i][j] = 0x3C00;
    // }
    // for(int i=0;i<cfg.Padding_Feature_Head;i++)
    // {
    //     for(int j=0;j<cfg.CHout;j++)
