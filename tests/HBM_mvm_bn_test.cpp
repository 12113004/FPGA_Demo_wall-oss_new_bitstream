...
void HBM_mvmbn_receive_and_compare(struct FPGA_HBM_MVM_BN_cfg cfg, HANDLE c2hx_device, char* path_name, char* head_name, struct bin_inf* standard_out_bin_inf, BOOL NO_COMPARE=false)
{
