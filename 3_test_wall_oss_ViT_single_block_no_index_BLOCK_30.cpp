...
//    test_load_block00_weights(h2cx_device[0], "BLOCK_write_data_qwen3");
    ...
    struct FPGA_HBM_LN_cfg cfg_ln0 = GetFPGA_HBM_LN_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime1, /*LN_WT_BASE_ADDR*/ hbm514, /*DAT_OUT_BASE_ADDR*/ runtime0
    );
    // Input bin_inf
    struct bin_inf* ln0_dat_in_bin_inf   = get_bin_inf(0, run_token*1*hidden_dim,  "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm1/input.bin");
    struct bin_inf* ln0_weight_bin_inf   = get_bin_inf(0, 1*hidden_dim,            "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm1/weight.bin");
    ...
    // Transform data
    HBM_ln_test(cfg_ln0, "wall_oss_run/blocks_30", "LN0", ln0_dat_in_bin_inf, ln0_weight_bin_inf, ln0_bias_bin_inf, ln0_dat_in_HBM_inf, ENABLE, ln0_ln_wt_and_bias_HBM_inf, ENABLE);
    ...
    norm_step_632(user_device, run_token);

    // Read output data from FPGA and compare
    // struct bin_inf* ln0_golden_out_bin_inf = get_bin_inf(0, run_token*1*hidden_dim, "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm1/output.bin");
    // HBM_ln_receive_and_compare(cfg_ln0, c2hx_device[0], "wall_oss_run/blocks_30", "LN0", ln0_golden_out_bin_inf);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_q = GetFPGA_HBM_MVM_BN_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm515, /*BN_BASE_ADDR*/ hbm516, /*DAT_OUT_BASE_ADDR*/ runtime3
    );

    // Input bin_inf
    struct bin_inf* mvmbn0_q_dat_in_bin_inf = get_bin_inf(0, run_token*1*hidden_dim,  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_q_proj/input.bin");
    struct bin_inf* mvmbn0_q_weight_bin_inf = get_bin_inf(0, hidden_dim*4*16*128,     "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_q_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn0_q_scales_bin_inf = get_bin_inf(0, 4*16*128*hidden_dim/128, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_q_proj/scale.bin");
    struct bin_inf* mvmbn0_q_wt_bin_inf     = get_bin_inf(0, 4*16*128,                "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn0_q_bias_bin_inf   = get_bin_inf(0, 4*16*128,                "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_q_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn0_q, "wall_oss_run/blocks_30", "MVMBN0_Q", mvmbn0_q_weight_bin_inf, mvmbn0_q_scales_bin_inf, mvmbn0_q_dat_in_bin_inf, mvmbn0_q_wt_bin_inf, mvmbn0_q_bias_bin_inf,
    ...
    // Write command to FPGA
    mvm_f16xi4_step_633(user_device, run_token);

    // Read output data from FPGA and compare
    // struct bin_inf* mvmbn0_q_golden_out_bin_inf = get_bin_inf(0, run_token*1*4*16*128, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_q_proj/output.bin");
    // HBM_mvmbn_receive_and_compare(cfg_mvmbn0_q, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN0_Q",  mvmbn0_q_golden_out_bin_inf);
    ...
    struct FPGA_HBM_EMB_cfg cfg_embq = GetFPGA_HBM_EMB_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime3, /*POS_IN_BASE_ADDR*/ hbm5, /*DAT_OUT_BASE_ADDR*/ runtime2
    );

    // Input bin_inf
    struct bin_inf* embq_dat_in_bin_inf = get_bin_inf(0, run_token*4*16*128,     "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/q_input.bin");
    struct bin_inf* embq_pos_in_bin_inf = get_bin_inf(0, 2048*128,               "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/cos_sin.bin"); 
    // Output bin_inf
    ...
    // Transform data
    HBM_emb_test(cfg_embq, "wall_oss_run/blocks_30", "EMBQ", embq_dat_in_bin_inf, embq_pos_in_bin_inf, embq_dat_in_HBM_inf, ENABLE, embq_pos_in_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    rope_step_634(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // struct bin_inf* embq_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/q_output.bin"); 
    // HBM_emb_receive_and_compare(cfg_embq, c2hx_device[0], "wall_oss_run/blocks_30", "EMBQ", embq_golden_out_bin_inf);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_k = GetFPGA_HBM_MVM_BN_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm517, /*BN_BASE_ADDR*/ hbm518, /*DAT_OUT_BASE_ADDR*/ runtime4
    );
    // Input bin_inf
    struct bin_inf* mvmbn0_k_dat_in_bin_inf = get_bin_inf(0, run_token*1*hidden_dim,  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_k_proj/input.bin");
    struct bin_inf* mvmbn0_k_weight_bin_inf = get_bin_inf(0, hidden_dim*16*128,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_k_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn0_k_scales_bin_inf = get_bin_inf(0, 16*128*hidden_dim/128,   "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_k_proj/scale.bin");
    struct bin_inf* mvmbn0_k_wt_bin_inf     = get_bin_inf(0, 16*128,                  "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn0_k_bias_bin_inf   = get_bin_inf(0, 16*128,                  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_k_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn0_k, "wall_oss_run/blocks_30", "MVMBN0_K", mvmbn0_k_weight_bin_inf, mvmbn0_k_scales_bin_inf, mvmbn0_k_dat_in_bin_inf, mvmbn0_k_wt_bin_inf, mvmbn0_k_bias_bin_inf,
    ...
    // Write command to FPGA
    mvm_f16xi4_step_635(user_device, run_token);
    
    // Read output data from FPGA and compare
    // struct bin_inf* mvmbn0_k_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_k_proj/output.bin");
    // HBM_mvmbn_receive_and_compare(cfg_mvmbn0_k, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN0_K", mvmbn0_k_golden_out_bin_inf);
    ...
    struct FPGA_HBM_EMB_cfg cfg_embk = GetFPGA_HBM_EMB_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime4, /*POS_IN_BASE_ADDR*/ hbm5, /*DAT_OUT_BASE_ADDR*/ runtime3
    );

    // Input bin_inf
    struct bin_inf* embk_dat_in_bin_inf = get_bin_inf(0, run_token*16*128,   "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/k_input.bin");
    struct bin_inf* embk_pos_in_bin_inf = get_bin_inf(0, 2048*128,           "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/cos_sin.bin"); 
    // Output bin_inf
    ...
    // Transform data
    HBM_emb_test(cfg_embk, "wall_oss_run/blocks_30", "EMBK", embk_dat_in_bin_inf, embk_pos_in_bin_inf, embk_dat_in_HBM_inf, ENABLE, embk_pos_in_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    rope_step_636(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // struct bin_inf* embk_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/k_output.bin");
    // HBM_emb_receive_and_compare(cfg_embk, c2hx_device[0], "wall_oss_run/blocks_30", "EMBK", embk_golden_out_bin_inf);
    ...
    struct FPGA_HBM_KV2HBM_cfg cfg_kv2hbmk = GetFPGA_HBM_KV2HBM_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime3, /*DAT_OUT_BASE_ADDR*/ hbm_cache60
    );

    // Input bin_inf
    struct bin_inf* kv2hbmk_dat_in_bin_inf = get_bin_inf(0, run_token*16*128, "./wall_oss/blocks_30/ROPE_visual_blocks_30_attn/k_output.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_kv2hbm_test(cfg_kv2hbmk, "wall_oss_run/blocks_30", "KV2HBMK", kv2hbmk_dat_in_bin_inf, kv2hbmk_dat_in_HBM_inf, kv2hbmk_golden_out_bin_inf, ENABLE);

    // Write data to FPGA
    // HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], kv2hbmk_dat_in_HBM_inf, group);

    // Write command to FPGA
    kvcache2hbm_step_637(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // HBM_kv2hbm_receive_and_compare(cfg_kv2hbmk, c2hx_device[0], "wall_oss_run/blocks_30", "KV2HBMK", kv2hbmk_golden_out_bin_inf[0], K_Mode);
    ...
    struct FPGA_HBM_TRP_cfg cfg_trp = GetFPGA_HBM_TRP_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime2, /*WT_BASE_ADDR*/ hbm_cache60, /*DAT_OUT_BASE_ADDR*/ runtime3
    );

    // Input bin_inf
    struct bin_inf* trp_dat_in_bin_inf = get_bin_inf(0, run_token*4*16*128,      "./wall_oss/blocks_30/TRP/q.bin");
    struct bin_inf* trp_wt_in_bin_inf  = get_bin_inf(0, run_token*16*128,        "./wall_oss/blocks_30/TRP/k.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_trp_test(cfg_trp, "wall_oss_run/blocks_30", "TRP", trp_dat_in_bin_inf, trp_wt_in_bin_inf, trp_dat_in_HBM_inf, ENABLE, trp_wt_in_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    mvm_f16xf16_step_638(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // struct bin_inf* trp_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/TRP/attn_weights.bin");
    // HBM_trp_receive_and_compare(cfg_trp, c2hx_device[0], "wall_oss_run/blocks_30", "TRP", trp_golden_out_bin_inf);
    ...
    struct FPGA_HBM_ELEMENTWISE_cfg cfg_elementwise0 = GetFPGA_HBM_ELEMENTWISE_cfg(
        ...
        /*DAT_IN_A_BASE_ADDR*/ runtime3, /*DAT_IN_B_BASE_ADDR*/ hbm519, /*DAT_OUT_BASE_ADDR*/ runtime2 
    );
    
    // Input bin_inf
    struct bin_inf* elementwise0_dat_in_A_bin_inf  = get_bin_inf(0, 16*4*run_token*672,   "./wall_oss/blocks_30/ATTN_MASK/input.bin");
    struct bin_inf* elementwise0_dat_in_B_bin_inf  = get_bin_inf(0, 16*4*run_token*672,   "./wall_oss/blocks_30/ATTN_MASK/mask.bin");
    ...
    // Transform data
    HBM_elementwise_test(cfg_elementwise0, "wall_oss_run/blocks_30", "ATTEN_MASK", elementwise0_dat_in_A_bin_inf, elementwise0_dat_in_B_bin_inf, elementwise0_dat_in_A_HBM_inf, ENABLE, elementwise0_dat_in_B_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    elementwise_step_639(user_device);
    // elementwise_step_9(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // struct bin_inf* elementwise0_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/ATTN_MASK/output.bin");
    // HBM_elementwise_receive_and_compare(cfg_elementwise0, c2hx_device[0], "wall_oss_run/blocks_30", "ATTEN_MASK", elementwise0_golden_out_bin_inf);
    ...
    struct FPGA_HBM_SOFTMAX_cfg cfg_softmax = GetFPGA_HBM_SOFTMAX_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime2, /*DAT_OUT_BASE_ADDR*/ runtime3
    );

    // Input bin_inf
    struct bin_inf* softmax_dat_in_bin_inf = get_bin_inf(0, 16*run_token*run_token, "./wall_oss/blocks_30/SOFTMAX/input.bin");
    // Output bin_inf
    struct bin_inf* *softmax_dat_in_HBM_inf = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);

    // Transform data
    HBM_softmax_test(cfg_softmax , "wall_oss_run/blocks_30", "SOFTMAX", softmax_dat_in_bin_inf, softmax_dat_in_HBM_inf, ENABLE);

    // Write data to FPGA
    // HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], softmax_dat_in_HBM_inf, group);

    // Write command to FPGA
    softmax_step_640(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // struct bin_inf* softmax_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/SOFTMAX/output.bin");
    // HBM_softmax_receive_and_compare(cfg_softmax, c2hx_device[0], "wall_oss_run/blocks_30", "SOFTMAX", softmax_golden_out_bin_inf);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_v = GetFPGA_HBM_MVM_BN_cfg(
        /*Height*/ run_token, /*Hin*/ 1, /*Width_in*/ hidden_dim, /*Width_out*/ 16*128,
        /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm520, /*BN_BASE_ADDR*/ hbm521, /*DAT_OUT_BASE_ADDR*/ runtime4
    );
    // Input bin_inf
    struct bin_inf* mvmbn0_v_dat_in_bin_inf = get_bin_inf(0, run_token*1*hidden_dim,  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/input.bin");
    struct bin_inf* mvmbn0_v_weight_bin_inf = get_bin_inf(0, hidden_dim*16*128,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn0_v_scales_bin_inf = get_bin_inf(0, 16*128*hidden_dim/128,   "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/scale.bin");
    struct bin_inf* mvmbn0_v_wt_bin_inf     = get_bin_inf(0, 16*128,                  "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn0_v_bias_bin_inf   = get_bin_inf(0, 16*128,                  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn0_v, "wall_oss_run/blocks_30", "MVMBN0_V", mvmbn0_v_weight_bin_inf, mvmbn0_v_scales_bin_inf, mvmbn0_v_dat_in_bin_inf, mvmbn0_v_wt_bin_inf, mvmbn0_v_bias_bin_inf,
    ...
    // Write command to FPGA
    mvm_f16xi4_step_641(user_device, run_token);
    
    // Read output data from FPGA and compare
    // struct bin_inf* mvmbn0_v_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/output.bin");
    // HBM_mvmbn_receive_and_compare(cfg_mvmbn0_v, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN0_V", mvmbn0_v_golden_out_bin_inf);
    ...
    struct FPGA_HBM_KV2HBM_cfg cfg_kv2hbmv = GetFPGA_HBM_KV2HBM_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime4, /*DAT_OUT_BASE_ADDR*/ hbm_cache61
    );

    // Input bin_inf
    struct bin_inf* kv2hbmv_dat_in_bin_inf = get_bin_inf(0, 8*19*128, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_qkv_v_proj/output.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_kv2hbm_test(cfg_kv2hbmv, "wall_oss_run/blocks_30", "KV2HBMV", kv2hbmv_dat_in_bin_inf, kv2hbmv_dat_in_HBM_inf, kv2hbmv_golden_out_bin_inf, ENABLE);

    // Write data to FPGA
    // HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], kv2hbmv_dat_in_HBM_inf, group);

    // Write command to FPGA
    kvcache2hbm_step_642(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    // HBM_kv2hbm_receive_and_compare(cfg_kv2hbmv, c2hx_device[0], "wall_oss_run/blocks_30",  "KV2HBMV", kv2hbmv_golden_out_bin_inf[0], V_Mode);
    ...
    struct FPGA_HBM_F2W_cfg cfg_f2w = GetFPGA_HBM_F2W_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime3, /*WT_BASE_ADDR*/ hbm_cache61, /*DAT_OUT_BASE_ADDR*/ runtime2
    );

    // Input bin_inf
    struct bin_inf* f2w_dat_in_bin_inf = get_bin_inf(0, 32*22*128,       "./wall_oss/blocks_30/F2W/attn_weights.bin");
    struct bin_inf* f2w_wt_in_bin_inf  = get_bin_inf(0, 8*22*128,        "./wall_oss/blocks_30/F2W/v.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_f2w_test(cfg_f2w, "wall_oss_run/blocks_30", "F2W", f2w_dat_in_bin_inf, f2w_wt_in_bin_inf, f2w_dat_in_HBM_inf, ENABLE, f2w_wt_in_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    mvm_f16xf16_step_643(user_device, run_token, last_token);

    // Read output data from FPGA and compare
    struct bin_inf* f2w_golden_out_bin_inf = get_bin_inf(0, 32*22*128, "./wall_oss/blocks_30/F2W/attn_output.bin");
    HBM_f2w_receive_and_compare(cfg_f2w, c2hx_device[0], "wall_oss_run/blocks_30", "F2W", f2w_golden_out_bin_inf);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn1 = GetFPGA_HBM_MVM_BN_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime2, /*HBM00_WT_BASE_ADDR*/ hbm522, /*BN_BASE_ADDR*/ hbm523, /*DAT_OUT_BASE_ADDR*/ runtime0
    );

    // Input bin_inf
    struct bin_inf* mvmbn1_dat_in_bin_inf = get_bin_inf(0, 22*1*4096,            "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_proj/input.bin");
    struct bin_inf* mvmbn1_weight_bin_inf = get_bin_inf(0, 4096*4096,            "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn1_scales_bin_inf = get_bin_inf(0, 32*4096,              "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_proj/scale.bin");
    struct bin_inf* mvmbn1_wt_bin_inf     = get_bin_inf(0, 4096,                 "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn1_bias_bin_inf   = get_bin_inf(0, 4096,                 "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn1, "wall_oss_run/blocks_30", "MVMBN1", mvmbn1_weight_bin_inf, mvmbn1_scales_bin_inf, mvmbn1_dat_in_bin_inf, mvmbn1_wt_bin_inf, mvmbn1_bias_bin_inf,
    ...
    // Write command to FPGA
    mvm_f16xi4_step_644 (user_device, run_token);

    // Read output data from FPGA and compare
    struct bin_inf* mvmbn1_golden_out_bin_inf = get_bin_inf(0, 0,                "./wall_oss/blocks_30/LINEAR_visual_blocks_30_attn_proj/output.bin");
    HBM_mvmbn_receive_and_compare(cfg_mvmbn1, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN1", mvmbn1_golden_out_bin_inf);
    ...
    // Write command to FPGA
    elementwise_step_645(user_device, run_token);
    ...
    struct FPGA_HBM_LN_cfg cfg_ln1 = GetFPGA_HBM_LN_cfg(
        ...
        /*DAT_IN_BASE_ADDR*/ runtime4, /*LN_WT_BASE_ADDR*/ hbm524, /*DAT_OUT_BASE_ADDR*/ runtime1
    );
    // Input bin_inf
    struct bin_inf* ln1_dat_in_bin_inf   = get_bin_inf(0, 22*1*4096,         "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm2/input.bin");
    struct bin_inf* ln1_weight_bin_inf   = get_bin_inf(0, 1*4096,            "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm2/weight.bin");
    ...
    // Transform data
    HBM_ln_test(cfg_ln1, "wall_oss_run/blocks_30", "LN1", ln1_dat_in_bin_inf, ln1_weight_bin_inf, ln1_bias_bin_inf, ln1_dat_in_HBM_inf, ENABLE, ln1_ln_wt_and_bias_HBM_inf, ENABLE);
    ...
    // Write command to FPGA
    norm_step_646(user_device, run_token);

    // Read output data from FPGA and compare
    struct bin_inf* ln1_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/RMSNORM_visual_blocks_30_norm2/output.bin");
    HBM_ln_receive_and_compare(cfg_ln1, c2hx_device[0], "wall_oss_run/blocks_30", "LN1", ln1_golden_out_bin_inf);
    ...
    // Input bin_inf
    struct bin_inf* mvmbn2_dat_in_bin_inf = get_bin_inf(0, 22*1*4096,        "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_gate_proj/input.bin");
    struct bin_inf* mvmbn2_weight_bin_inf = get_bin_inf(0, 12288*4096,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_gate_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn2_scales_bin_inf = get_bin_inf(0, 12288*32,         "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_gate_proj/scale.bin");
    struct bin_inf* mvmbn2_wt_bin_inf     = get_bin_inf(0, 12288,            "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn2_bias_bin_inf   = get_bin_inf(0, 12288,            "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_gate_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn2, "wall_oss_run/blocks_30", "MVMBN2", mvmbn2_weight_bin_inf, mvmbn2_scales_bin_inf, mvmbn2_dat_in_bin_inf, mvmbn2_wt_bin_inf, mvmbn2_bias_bin_inf,
    ...
    // Read output data from FPGA and compare
    struct bin_inf* mvmbn2_golden_out_bin_inf = get_bin_inf(0, 0, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_gate_proj/output.bin");
    HBM_mvmbn_receive_and_compare(cfg_mvmbn2, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN2", mvmbn2_golden_out_bin_inf);
    ...
    // Input bin_inf
    struct bin_inf* act_dat_in_bin_inf = get_bin_inf(0, 22*1*12288,         "./wall_oss/blocks_30/ACT/input.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_act_test(cfg_act, "wall_oss_run/blocks_30", "ACT", act_dat_in_bin_inf, act_dat_in_HBM_inf, ENABLE, act_parameter_in_HBM_inf, ENABLE);
    ...
    // Read output data from FPGA and compare
    struct bin_inf* act_golden_out_bin_inf = get_bin_inf(0, 0,          "./wall_oss/blocks_30/ACT/output.bin");
    ...
    // Input bin_inf
    struct bin_inf* mvmbn3_dat_in_bin_inf = get_bin_inf(0, 22*1*4096,        "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_up_proj/input.bin");
    struct bin_inf* mvmbn3_weight_bin_inf = get_bin_inf(0, 12288*4096,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_up_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn3_scales_bin_inf = get_bin_inf(0, 12288*32,         "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_up_proj/scale.bin");
    struct bin_inf* mvmbn3_wt_bin_inf     = get_bin_inf(0, 12288,            "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn3_bias_bin_inf   = get_bin_inf(0, 12288,            "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_up_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn3, "wall_oss_run/blocks_30", "MVMBN3", mvmbn3_weight_bin_inf, mvmbn3_scales_bin_inf, mvmbn3_dat_in_bin_inf, mvmbn3_wt_bin_inf, mvmbn3_bias_bin_inf,
    ...
    // Read output data from FPGA and compare
    struct bin_inf* mvmbn3_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_up_proj/output.bin");
    ...
    // Input bin_inf
    struct bin_inf* mvmbn4_dat_in_bin_inf = get_bin_inf(0, run_token*3456,  "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_down_proj/input.bin");
    struct bin_inf* mvmbn4_weight_bin_inf = get_bin_inf(0, 3456*1280,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_down_proj/weight_int4.bin"); 
    struct bin_inf* mvmbn4_scales_bin_inf = get_bin_inf(0, 1280*27,         "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_down_proj/scale.bin");
    struct bin_inf* mvmbn4_wt_bin_inf     = get_bin_inf(0, 1280,            "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn4_bias_bin_inf   = get_bin_inf(0, 1280,            "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_down_proj/bias.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn4, "wall_oss_run/blocks_30", "MVMBN4", mvmbn4_weight_bin_inf, mvmbn4_scales_bin_inf, mvmbn4_dat_in_bin_inf, mvmbn4_wt_bin_inf, mvmbn4_bias_bin_inf,
    ...
    // Read output data from FPGA and compare
    struct bin_inf* mvmbn4_golden_out_bin_inf = get_bin_inf(0, 0,       "./wall_oss/blocks_30/LINEAR_visual_blocks_30_mlp_down_proj/output.bin");
    HBM_mvmbn_receive_and_compare(cfg_mvmbn4, c2hx_device[0], "wall_oss_run/blocks_30", "MVMBN4", mvmbn4_golden_out_bin_inf);
    ...
    HBM_elementwise_receive_and_compare(cfg_elementwise2, c2hx_device[0], "wall_oss_run/blocks_30", "ELEMENTWISE2", elementwise2_golden_out_bin_inf);
   ...
   HBM_bin_inf_malloc_free(ln_outlayer_ln_wt_and_bias_HBM_inf, group);
    ...
    struct bin_inf* mvmbn_argmax_30_weight_bin_inf = get_bin_inf(0, 37984*4096, "./rw_data/qwen3_all_weights/lm_head.weights_1.bin"); 
    struct bin_inf* mvmbn_argmax_30_scales_bin_inf = get_bin_inf(0, 37984*32, "./rw_data/qwen3_all_weights/lm_head.scales_1.bin");
    ...
    // Output bin_inf
    struct bin_inf* *mvmbn_argmax_30_wt_and_scale_in_HBM_inf   = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);
    ...
    HBM_mvmbn_wt_test(cfg_mvmbn_argmax_0, "BLOCK_write_data_qwen3/BLOCK_OutLayer_test", "MVMBN_Argmax_0", mvmbn_argmax_30_weight_bin_inf, mvmbn_argmax_30_scales_bin_inf,
                mvmbn_argmax_30_wt_and_scale_in_HBM_inf, ENABLE);
    ...
    // Write data to FPGA
    HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], mvmbn_argmax_30_wt_and_scale_in_HBM_inf, group);
    ...
    bin_inf_malloc_free(mvmbn_argmax_30_weight_bin_inf);
    bin_inf_malloc_free(mvmbn_argmax_30_scales_bin_inf);
    ...
    HBM_bin_inf_malloc_free(mvmbn_argmax_30_wt_and_scale_in_HBM_inf, group);
