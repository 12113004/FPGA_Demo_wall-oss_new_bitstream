...
struct FPGA_HBM_Feature2Weight_cfg
{
    int Height;
    int Width_in;
...
void Feature2Weight_SOFT_FUNCTION(struct FPGA_HBM_Feature2Weight_cfg cfg, int *dat_in[], int *HBM_DDR[]);
void DAT_IN_TRANS_FUNCTION_Feature2Weight(struct FPGA_HBM_Feature2Weight_cfg cfg, int *dat_in[], int *HBM_DDR[]);
void Feature2Weight_Compare_FUNCTION(struct FPGA_HBM_Feature2Weight_cfg cfg, int *HBM_DDR_read[], int *HBM_DDR_soft[]);

#include "HBM_DDR_f2w.cpp"