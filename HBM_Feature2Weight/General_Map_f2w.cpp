...
#include "HBM_DDR_f2w.h"

void Feature2Weight_Map_Feature_Data(struct FPGA_HBM_Feature2Weight_cfg cfg, int Height, int Width, int CH, int *in, int *mem[])
{
//    printf("Height=%0d, Width=%0d, CH=%0d",Height,Width,CH);
    //for(int i=0;i<cfg.Hin*cfg.Win*cfg.CHout;i++)
    //{
    //    if(i<10)
    //    printf("in[%d]: %x.\n\r", i, in[i]);
    //}
