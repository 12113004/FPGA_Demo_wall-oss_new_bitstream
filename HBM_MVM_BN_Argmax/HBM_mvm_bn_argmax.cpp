...
#include "General_Map_mvm_bn_argmax.h"
...
{
    struct FPGA_HBM_MVM_BN_Argmax_cfg ret;
...
void BN_WT_AND_BIAS_IN_TRANS_FUNCTION_MVM_BN_Argmax(struct FPGA_HBM_MVM_BN_Argmax_cfg cfg, int *bn_wt, int *bn_bias, int *HBM[])
{
