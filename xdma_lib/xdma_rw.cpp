...
void CSB_Write_fprintf_addID(FILE *aux_test, HANDLE user_device, int last_token)
{
    if(last_token<1024)
    {
        fprintf(aux_test, "%d\n", 808464385);
...
void CSB_Write_fprintf_add0(FILE *aux_test, HANDLE user_device)
{
    for(int i=0;i<16;i++)
        fprintf(aux_test, "%d\n", 0);
}

void CSB_Write_printf(HANDLE user_device, int addr, int data)
{
    printf("%d\n", data);
}
