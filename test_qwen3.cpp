...
#include "./rw_cmd/qwen3_all_block_1126_0954.h"
...
//    // ******************************** STEP1 - LN0 ******************************** //
   ...
   struct bin_inf* ln0_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_LN0/LN0_output.bin");
   HBM_ln_receive_and_compare(cfg_ln0, c2hx_device[0], "BLOCK_read_data", "LN0", ln0_golden_out_bin_inf);
   ...
   // ******************************** STEP2 - MVMBN0_Q ******************************** //
      ...
      struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_q = GetFPGA_HBM_MVM_BN_cfg(
          /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 4096,
          /*DAT_IN_BASE_ADDR*/ runtime1, /*HBM00_WT_BASE_ADDR*/ hbm1, /*BN_BASE_ADDR*/ hbm2, /*DAT_OUT_BASE_ADDR*/ runtime2
      );

      // Input bin_inf
      struct bin_inf* mvmbn0_q_dat_in_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNQ/MVMBNQ_input.bin");
      struct bin_inf* mvmbn0_q_weight_bin_inf = get_bin_inf(0, 4096*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNQ/q_proj_int32.bin"); 
      struct bin_inf* mvmbn0_q_scales_bin_inf = get_bin_inf(0, 4096*32, "./qwen3_data/Qwen3_xiao/test_MVMBNQ/q_proj_scales.bin");
      struct bin_inf* mvmbn0_q_wt_bin_inf     = get_bin_inf(0, 4096, "./rw_data/bn_wt_1.bin");
      struct bin_inf* mvmbn0_q_bias_bin_inf   = get_bin_inf(0, 4096, "./rw_data/bn_and_k_bias_0.bin");
      // Output bin_inf
      ...
      // Transform data
      HBM_mvmbn_test(cfg_mvmbn0_q, "BLOCK_write_data/BLOCK00", "MVMBN0_Q", mvmbn0_q_weight_bin_inf, mvmbn0_q_scales_bin_inf, mvmbn0_q_dat_in_bin_inf, mvmbn0_q_wt_bin_inf, mvmbn0_q_bias_bin_inf,
      ...
      // Read output data from FPGA and compare
      struct bin_inf* mvmbn0_q_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNQ/MVMBNQ_output.bin");
      HBM_mvmbn_receive_and_compare(cfg_mvmbn0_q, c2hx_device[0], "BLOCK_read_data", "MVMBN0_Q", mvmbn0_q_golden_out_bin_inf);
...
//    // ******************************** STEP3 - LNQ ******************************** //
   // Parameter Config
   struct FPGA_HBM_LN_inout_head_cfg cfg_lnq = GetFPGA_HBM_LN_inout_head_cfg(
       /*This_Token*/ 22, /*Last_Token*/ 0, /*Padding_Feature_Head*/ 32, /*True_CH_per_HEAD*/ 128,
       /*DAT_IN_BASE_ADDR*/ runtime2, /*LN_WT_BASE_ADDR*/ hbm3, /*DAT_OUT_BASE_ADDR*/ runtime3
   );
   // Input bin_inf
   struct bin_inf* lnq_dat_in_bin_inf   = get_bin_inf(0, 22*32*128, "./qwen3_data/Qwen3_xiao/test_LNQ/LNQ_input.bin");
   struct bin_inf* lnq_weight_bin_inf   = get_bin_inf(0, 32*128, "./qwen3_data/Qwen3_xiao/test_LNQ/LNQ_weights.bin");
   struct bin_inf* lnq_bias_bin_inf     = get_bin_inf(0, 32*128, "./rw_data/bn_and_k_bias_0.bin");
   // Output bin_inf
   struct bin_inf* *lnq_dat_in_HBM_inf         = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);
   struct bin_inf* *lnq_ln_wt_and_bias_HBM_inf = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);

   // Transform data
   HBM_ln_inout_head_test(cfg_lnq, "BLOCK_write_data/BLOCK00", "LNQ", lnq_dat_in_bin_inf, lnq_weight_bin_inf, lnq_bias_bin_inf, lnq_dat_in_HBM_inf, ENABLE, lnq_ln_wt_and_bias_HBM_inf, ENABLE);

   // Write data to FPGA
   HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], lnq_dat_in_HBM_inf, group);   
   // HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], lnq_ln_wt_and_bias_HBM_inf, group);

   // Write command to FPGA
   norm_step_3(user_device, run_token);

   // Read output data from FPGA and compare
   struct bin_inf* lnq_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_LNQ/LNQ_output.bin");
   HBM_ln_inout_head_receive_and_compare(cfg_lnq, c2hx_device[0], "BLOCK_read_data", "LN0", lnq_golden_out_bin_inf);

   // Malloc free
   bin_inf_malloc_free(lnq_dat_in_bin_inf);
   bin_inf_malloc_free(lnq_weight_bin_inf);
   bin_inf_malloc_free(lnq_bias_bin_inf);
   bin_inf_malloc_free(lnq_golden_out_bin_inf );
   HBM_bin_inf_malloc_free(lnq_dat_in_HBM_inf, group);
   HBM_bin_inf_malloc_free(lnq_ln_wt_and_bias_HBM_inf, group);
#endif
   ...
   HBM_bin_inf_malloc_free(embq_pos_in_HBM_inf, group);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_k = GetFPGA_HBM_MVM_BN_cfg(
        /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 1024,
        /*DAT_IN_BASE_ADDR*/ runtime1, /*HBM00_WT_BASE_ADDR*/ hbm5, /*BN_BASE_ADDR*/ hbm6, /*DAT_OUT_BASE_ADDR*/ runtime3
    );
    // Input bin_inf
    struct bin_inf* mvmbn0_k_dat_in_bin_inf = get_bin_inf(0, 19*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNK/MVMBNK_input.bin");
    struct bin_inf* mvmbn0_k_weight_bin_inf = get_bin_inf(0, 1024*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNK/k_proj_int32.bin"); 
    struct bin_inf* mvmbn0_k_scales_bin_inf = get_bin_inf(0, 1024*32, "./qwen3_data/Qwen3_xiao/test_MVMBNK/k_proj_scales.bin");
    struct bin_inf* mvmbn0_k_wt_bin_inf     = get_bin_inf(0, 1024, "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn0_k_bias_bin_inf   = get_bin_inf(0, 1024, "./rw_data/bn_and_k_bias_0.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn0_k, "BLOCK_write_data/BLOCK00", "MVMBN0_K", mvmbn0_k_weight_bin_inf, mvmbn0_k_scales_bin_inf, mvmbn0_k_dat_in_bin_inf, mvmbn0_k_wt_bin_inf, mvmbn0_k_bias_bin_inf,
   ...
   //  HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], mvmbn0_k_dat_in_HBM_inf, group);
    ...
    // Read output data from FPGA and compare
    struct bin_inf* mvmbn0_k_golden_out_bin_inf = get_bin_inf(0, 0, "./qwen3_data/Qwen3_xiao/test_MVMBNK/MVMBNK_output.bin");
   //  HBM_mvmbn_receive_and_compare(cfg_mvmbn0_k, c2hx_device[0], "BLOCK_read_data", "MVMBN0_K", mvmbn0_k_golden_out_bin_inf);
...
//    // ******************************** STEP6 - LNK ******************************** //
   // Parameter Config
   struct FPGA_HBM_LN_inout_head_cfg cfg_lnk = GetFPGA_HBM_LN_inout_head_cfg(
       /*This_Token*/ 22, /*Last_Token*/ 0, /*Padding_Feature_Head*/ 8, /*True_CH_per_HEAD*/ 128,
       /*DAT_IN_BASE_ADDR*/ runtime3, /*LN_WT_BASE_ADDR*/ hbm7, /*DAT_OUT_BASE_ADDR*/ runtime4
   );
   // Input bin_inf
   struct bin_inf* lnk_dat_in_bin_inf   = get_bin_inf(0, 22*8*128, "./qwen3_data/Qwen3_xiao/test_LNK/LNK_input.bin");
   struct bin_inf* lnk_weight_bin_inf   = get_bin_inf(0, 128, "./qwen3_data/Qwen3_xiao/test_LNK/LNK_weights.bin");
   struct bin_inf* lnk_bias_bin_inf     = get_bin_inf(0, 128, "./rw_data/bn_and_k_bias_0.bin");
   // Output bin_inf
   struct bin_inf* *lnk_dat_in_HBM_inf         = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);
   struct bin_inf* *lnk_ln_wt_and_bias_HBM_inf = (struct bin_inf**)malloc(sizeof(struct bin_inf)*group);

   // Transform data
   HBM_ln_inout_head_test(cfg_lnk, "BLOCK_write_data/BLOCK00", "LNK", lnk_dat_in_bin_inf, lnk_weight_bin_inf, lnk_bias_bin_inf, lnk_dat_in_HBM_inf, ENABLE, lnk_ln_wt_and_bias_HBM_inf, ENABLE);

   // Write data to FPGA
   // HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], lnk_dat_in_HBM_inf, group);
   HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], lnk_ln_wt_and_bias_HBM_inf, group);

   // Write command to FPGA
   norm_step_6(user_device, run_token);

   // Read output data from FPGA and compare
   struct bin_inf* lnk_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_LNK/LNK_output.bin");
   // HBM_ln_inout_head_receive_and_compare(cfg_lnk, c2hx_device[0], "BLOCK_read_data", "LN0", lnk_golden_out_bin_inf);

   // Malloc free
   bin_inf_malloc_free(lnk_dat_in_bin_inf);
   bin_inf_malloc_free(lnk_weight_bin_inf);
   bin_inf_malloc_free(lnk_bias_bin_inf);
   bin_inf_malloc_free(lnk_golden_out_bin_inf );
   HBM_bin_inf_malloc_free(lnk_dat_in_HBM_inf, group);
   HBM_bin_inf_malloc_free(lnk_ln_wt_and_bias_HBM_inf, group);
#endif
   ...
   struct FPGA_HBM_EMB_cfg cfg_embk = GetFPGA_HBM_EMB_cfg(
       /*Head*/ 8, /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 128, /*MAX_TOKEN*/ 2048, 
       /*DAT_IN_BASE_ADDR*/ runtime4, /*POS_IN_BASE_ADDR*/ hbm4, /*DAT_OUT_BASE_ADDR*/ runtime3
   );

   // Input bin_inf
   struct bin_inf* embk_dat_in_bin_inf = get_bin_inf(0, 8*19*128, "./qwen3_data/Qwen3_xiao/test_k_rope_xiao/k_rope_input.bin");
   struct bin_inf* embk_pos_in_bin_inf = get_bin_inf(0, 2048*128, "./qwen3_data/Qwen3_xiao/ROPE_max_token2048_pos_data.bin");
   // Output bin_inf
   ...
   // Transform data
   HBM_emb_test(cfg_embk, "BLOCK_write_data/BLOCK00", "EMBK", embk_dat_in_bin_inf, embk_pos_in_bin_inf, embk_dat_in_HBM_inf, ENABLE, embk_pos_in_HBM_inf, ENABLE);
   ...
   // Write command to FPGA
   rope_step_7(user_device, run_token, last_token);

   // Read output data from FPGA and compare
   struct bin_inf* embk_golden_out_bin_inf = get_bin_inf(0, 8*19*128, "./qwen3_data/Qwen3_xiao/test_k_rope_xiao/k_rope_output.bin");
   // HBM_emb_receive_and_compare(cfg_embk, c2hx_device[0], "BLOCK_read_data", "EMBK", embk_golden_out_bin_inf);
...
//    HBM_kv2hbm_receive_and_compare(cfg_kv2hbmk, c2hx_device[0], "BLOCK_read_data", "KV2HBMK", kv2hbmk_golden_out_bin_inf[0], K_Mode);
   ...
   HBM_bin_inf_malloc_free(softmax_dat_in_HBM_inf, group);
    ...
    struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn0_v = GetFPGA_HBM_MVM_BN_cfg(
        /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 1024,
        /*DAT_IN_BASE_ADDR*/ runtime1, /*HBM00_WT_BASE_ADDR*/ hbm8, /*BN_BASE_ADDR*/ hbm9, /*DAT_OUT_BASE_ADDR*/ runtime4
    );
    // Input bin_inf
    struct bin_inf* mvmbn0_v_dat_in_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNV/MVMBNV_input.bin");
    struct bin_inf* mvmbn0_v_weight_bin_inf = get_bin_inf(0, 1024*4096, "./qwen3_data/Qwen3_xiao/test_MVMBNV/v_proj_int32.bin"); 
    struct bin_inf* mvmbn0_v_scales_bin_inf = get_bin_inf(0, 1024*32, "./qwen3_data/Qwen3_xiao/test_MVMBNV/v_proj_scales.bin");
    struct bin_inf* mvmbn0_v_wt_bin_inf     = get_bin_inf(0, 1024, "./rw_data/bn_wt_1.bin");
    struct bin_inf* mvmbn0_v_bias_bin_inf   = get_bin_inf(0, 1024, "./rw_data/bn_and_k_bias_0.bin");
    // Output bin_inf
    ...
    // Transform data
    HBM_mvmbn_test(cfg_mvmbn0_v, "BLOCK_write_data/BLOCK00", "MVMBN0_V", mvmbn0_v_weight_bin_inf, mvmbn0_v_scales_bin_inf, mvmbn0_v_dat_in_bin_inf, mvmbn0_v_wt_bin_inf, mvmbn0_v_bias_bin_inf,
   ...
   //  HBM_bin_write_and_verify(h2cx_device[0], c2hx_device[0], mvmbn0_v_bn_wt_and_bias_in_HBM_inf, group);
    ...
    // Read output data from FPGA and compare
    struct bin_inf* mvmbn0_v_golden_out_bin_inf = get_bin_inf(0, 0, "./qwen3_data/Qwen3_xiao/test_MVMBNV/MVMBNV_output.bin");
   //  HBM_mvmbn_receive_and_compare(cfg_mvmbn0_v, c2hx_device[0], "BLOCK_read_data", "MVMBN0_V", mvmbn0_v_golden_out_bin_inf);
   ...
   // Input bin_inf
   struct bin_inf* kv2hbmv_dat_in_bin_inf = get_bin_inf(0, 8*19*128, "./qwen3_data/Qwen3/test_qkv/v/layer0_after_v_proj(MVMBN0).bin");
   // Output bin_inf
   ...
   // Transform data
   HBM_kv2hbm_test(cfg_kv2hbmv, "BLOCK_write_data/BLOCK00", "KV2HBMV", kv2hbmv_dat_in_bin_inf, kv2hbmv_dat_in_HBM_inf, kv2hbmv_golden_out_bin_inf, ENABLE);
   ...
   // Read output data from FPGA and compare
//    HBM_kv2hbm_receive_and_compare(cfg_kv2hbmv, c2hx_device[0], "BLOCK_read_data", "KV2HBMV", kv2hbmv_golden_out_bin_inf[0], V_Mode);
   ...
   // Input bin_inf
   struct bin_inf* f2w_dat_in_bin_inf = get_bin_inf(0, 32*22*128, "./qwen3_data/Qwen3_xiao/test_F2W_test/attn_weights.bin");
   struct bin_inf* f2w_wt_in_bin_inf  = get_bin_inf(0, 8*22*128, "./qwen3_data/Qwen3_xiao/test_F2W_test/value_states.bin");
   // Output bin_inf
   ...
   // Transform data
   HBM_f2w_test(cfg_f2w, "BLOCK_write_data/BLOCK00", "F2W", f2w_dat_in_bin_inf, f2w_wt_in_bin_inf, f2w_dat_in_HBM_inf, ENABLE, f2w_wt_in_HBM_inf, ENABLE);
   ...
   // Read output data from FPGA and compare
   struct bin_inf* f2w_golden_out_bin_inf = get_bin_inf(0, 32*22*128, "./qwen3_data/Qwen3_xiao/test_F2W_test/attn_output.bin");
   // HBM_f2w_receive_and_compare(cfg_f2w, c2hx_device[0], "BLOCK_read_data", "F2W", f2w_golden_out_bin_inf);
   ...
   struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn1 = GetFPGA_HBM_MVM_BN_cfg(
       /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 4096,
       /*DAT_IN_BASE_ADDR*/ runtime1, /*HBM00_WT_BASE_ADDR*/ hbm10, /*BN_BASE_ADDR*/ hbm11, /*DAT_OUT_BASE_ADDR*/ runtime2
   );

   // Input bin_inf
   struct bin_inf* mvmbn1_dat_in_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN1/MVMBN1_input.bin");
   struct bin_inf* mvmbn1_weight_bin_inf = get_bin_inf(0, 4096*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN1/o_proj_int32.bin"); 
   struct bin_inf* mvmbn1_scales_bin_inf = get_bin_inf(0, 32*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN1/o_proj_scales.bin");
   ...
   // Transform data
   HBM_mvmbn_test(cfg_mvmbn1, "BLOCK_write_data/BLOCK00", "MVMBN1", mvmbn1_weight_bin_inf, mvmbn1_scales_bin_inf, mvmbn1_dat_in_bin_inf, mvmbn1_wt_bin_inf, mvmbn1_bias_bin_inf,
   ...
   // Read output data from FPGA and compare
   struct bin_inf* mvmbn1_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN1/MVMBN1_output.bin");
   // HBM_mvmbn_receive_and_compare(cfg_mvmbn1, c2hx_device[0], "BLOCK_read_data", "MVMBN1", mvmbn1_golden_out_bin_inf);
   ...
   struct FPGA_HBM_LN_cfg cfg_ln1 = GetFPGA_HBM_LN_cfg(
      /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096,
      /*DAT_IN_BASE_ADDR*/ runtime1, /*LN_WT_BASE_ADDR*/ hbm12, /*DAT_OUT_BASE_ADDR*/ runtime0
  );
   // Input bin_inf
   struct bin_inf* ln1_dat_in_bin_inf   = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_LN1/LN1_input.bin");
   struct bin_inf* ln1_weight_bin_inf   = get_bin_inf(0, 1*4096, "./qwen3_data/Qwen3_xiao/test_LN1/LN1_weights.bin");
   ...
   // Transform data
   HBM_ln_test(cfg_ln1, "BLOCK_write_data/BLOCK00", "LN1", ln1_dat_in_bin_inf, ln1_weight_bin_inf, ln1_bias_bin_inf, ln1_dat_in_HBM_inf, ENABLE, ln1_ln_wt_and_bias_HBM_inf, ENABLE);
   ...
   // Read output data from FPGA and compare
   struct bin_inf* ln1_golden_out_bin_inf = get_bin_inf(0, 0, "./qwen3_data/Qwen3_xiao/test_LN1/LN1_output.bin");
   // HBM_ln_receive_and_compare(cfg_ln1, c2hx_device[0], "BLOCK_read_data", "LN1", ln1_golden_out_bin_inf);
   ...
   struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn2 = GetFPGA_HBM_MVM_BN_cfg(
       /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 12288,
       /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm13, /*BN_BASE_ADDR*/ hbm14, /*DAT_OUT_BASE_ADDR*/ runtime2
   );

   // Input bin_inf
   struct bin_inf* mvmbn2_dat_in_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN2/MVMBN2_in.bin");
   struct bin_inf* mvmbn2_weight_bin_inf = get_bin_inf(0, 12288*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN2/gate_proj_int32.bin"); 
   struct bin_inf* mvmbn2_scales_bin_inf = get_bin_inf(0, 12288*32, "./qwen3_data/Qwen3_xiao/test_MVMBN2/gate_proj_scales.bin");
   ...
   // Transform data
   HBM_mvmbn_test(cfg_mvmbn2, "BLOCK_write_data/BLOCK00", "MVMBN2", mvmbn2_weight_bin_inf, mvmbn2_scales_bin_inf, mvmbn2_dat_in_bin_inf, mvmbn2_wt_bin_inf, mvmbn2_bias_bin_inf,
   ...
   // Read output data from FPGA and compare
   struct bin_inf* mvmbn2_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN2/MVMBN2_out.bin");
   // HBM_mvmbn_receive_and_compare(cfg_mvmbn2, c2hx_device[0], "BLOCK_read_data", "MVMBN2", mvmbn2_golden_out_bin_inf);
   ...
   struct FPGA_HBM_ACT_cfg cfg_act = GetFPGA_HBM_ACT_cfg(
       ...
       /*DAT_IN_BASE_ADDR*/ runtime2, /*WT_BASE_ADDR*/ hbm15, /*DAT_OUT_BASE_ADDR*/ runtime3
   );

   // Input bin_inf
   struct bin_inf* act_dat_in_bin_inf = get_bin_inf(0, 22*1*12288, "./qwen3_data/Qwen3_xiao/test_ACT/ACT_in.bin");
   // Output bin_inf
   ...
   // Transform data
   HBM_act_test(cfg_act, "BLOCK_write_data/BLOCK00", "ACT", act_dat_in_bin_inf, act_dat_in_HBM_inf, ENABLE, act_parameter_in_HBM_inf, ENABLE);
   ...
   // Read output data from FPGA and compare
   struct bin_inf* act_golden_out_bin_inf = get_bin_inf(0, 22*1*12288, "./qwen3_data/Qwen3_xiao/test_ACT/ACT_out.bin");
   // struct bin_inf* act_golden_out_bin_inf = get_bin_inf(0, 22*1*12288, "./qwen3_data/Qwen3_xiao/test_ELEMENTWISE1/ELEMENTWISE1_input1.bin");
   ...
   struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn3 = GetFPGA_HBM_MVM_BN_cfg(
       /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 4096, /*Width_out*/ 12288,
       /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm16, /*BN_BASE_ADDR*/ hbm17, /*DAT_OUT_BASE_ADDR*/ runtime2
   );

   // Input bin_inf
   struct bin_inf* mvmbn3_dat_in_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN3/MVMBN3_in.bin");
   struct bin_inf* mvmbn3_weight_bin_inf = get_bin_inf(0, 12288*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN3/up_proj_int32.bin"); 
   struct bin_inf* mvmbn3_scales_bin_inf = get_bin_inf(0, 12288*32, "./qwen3_data/Qwen3_xiao/test_MVMBN3/up_proj_scales.bin");
   ...
   // Transform data
   HBM_mvmbn_test(cfg_mvmbn3, "BLOCK_write_data/BLOCK00", "MVMBN3", mvmbn3_weight_bin_inf, mvmbn3_scales_bin_inf, mvmbn3_dat_in_bin_inf, mvmbn3_wt_bin_inf, mvmbn3_bias_bin_inf,
   ...
   // Read output data from FPGA and compare
   struct bin_inf* mvmbn3_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN3/MVMBN3_out.bin");
   ...
   struct FPGA_HBM_MVM_BN_cfg cfg_mvmbn4 = GetFPGA_HBM_MVM_BN_cfg(
       /*Height*/ 22, /*Hin*/ 1, /*Width_in*/ 12288, /*Width_out*/ 4096,
       /*DAT_IN_BASE_ADDR*/ runtime0, /*HBM00_WT_BASE_ADDR*/ hbm18, /*BN_BASE_ADDR*/ hbm19, /*DAT_OUT_BASE_ADDR*/ runtime2
   );

   // Input bin_inf
   struct bin_inf* mvmbn4_dat_in_bin_inf = get_bin_inf(0, 22*1*12288, "./qwen3_data/Qwen3_xiao/test_MVMBN4/MVMBN4_in.bin");
   struct bin_inf* mvmbn4_weight_bin_inf = get_bin_inf(0, 4096*12288, "./qwen3_data/Qwen3_xiao/test_MVMBN4/down_proj_int32.bin"); 
   struct bin_inf* mvmbn4_scales_bin_inf = get_bin_inf(0, 4096*96, "./qwen3_data/Qwen3_xiao/test_MVMBN4/down_proj_scales.bin");
   struct bin_inf* mvmbn4_wt_bin_inf     = get_bin_inf(0, 4096, "./rw_data/bn_wt_1.bin");
   struct bin_inf* mvmbn4_bias_bin_inf   = get_bin_inf(0, 4096, "./rw_data/bn_and_k_bias_0.bin");
   // Output bin_inf
   ...
   // Transform data
   HBM_mvmbn_test(cfg_mvmbn4, "BLOCK_write_data/BLOCK00", "MVMBN4", mvmbn4_weight_bin_inf, mvmbn4_scales_bin_inf, mvmbn4_dat_in_bin_inf, mvmbn4_wt_bin_inf, mvmbn4_bias_bin_inf,
   ...
   // Read output data from FPGA and compare
   struct bin_inf* mvmbn4_golden_out_bin_inf = get_bin_inf(0, 22*1*4096, "./qwen3_data/Qwen3_xiao/test_MVMBN4/MVMBN4_out.bin");
   // HBM_mvmbn_receive_and_compare(cfg_mvmbn4, c2hx_device[0], "BLOCK_read_data", "MVMBN4", mvmbn4_golden_out_bin_inf);
