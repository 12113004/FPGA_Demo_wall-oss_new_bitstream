...
struct FPGA_HBM_ELEMENTWISE_cfg GetFPGA_HBM_ELEMENTWISE_cfg(int Height, int Hin, int Width_in, uint64_t DAT_IN_A_BASE_ADDR, uint64_t DAT_IN_B_BASE_ADDR, uint64_t DAT_OUT_BASE_ADDR)
{
    ...
    ret.DAT_IN_A_BASE_ADDR     = DAT_IN_A_BASE_ADDR;
    ret.DAT_IN_B_BASE_ADDR     = DAT_IN_B_BASE_ADDR;
...
void DAT_IN_TRANS_FUNCTION_ELEMENTWISE(struct FPGA_HBM_ELEMENTWISE_cfg cfg, int *dat_in[], int *HBM[])
{
...
void DAT_OUT_TRANS_FUNCTION_ELEMENTWISE(struct FPGA_HBM_ELEMENTWISE_cfg cfg, int *HBM[], uint16_t *dat_out[])
{
